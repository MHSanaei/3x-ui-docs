...
Reference outbound tags (including wildcards) in an Xray **balancer** to spread or
fail over traffic across a pool. The panel can report balancer status and let you
**override** a balancer to a specific outbound for testing.
