...
<p align="center">
  ...
  <a href="https://github.com/MHSanaei/3x-ui-docs/actions/workflows/ci.yml"><img src="https://github.com/MHSanaei/3x-ui-docs/actions/workflows/ci.yml/badge.svg" alt="CI" /></a>
...
This repository contains the source for [docs.sanaei.dev](https://docs.sanaei.dev) — a
static-first documentation and marketing site built with [Fumadocs](https://fumadocs.dev)
on Next.js. It has **no backend, no database, and no auth**: every page is prerendered and
every tool runs entirely in the browser.
...
This project uses **[pnpm](https://pnpm.io)** (npm lockfiles are gitignored).
